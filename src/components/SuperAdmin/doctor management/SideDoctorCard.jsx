...
const DoctorSideCardDesign = ({image, firstName, lastName, category, experience,profileFileName})=>{
    const name = `${firstName} ${lastName}`
    return(
        <div className="p-3 flex justify-start items-start border-2 border-gray-300 rounded-lg gap-5">
            <img src={`http://localhost:7000/upload/${profileFileName}`} alt="doctor image" className="w-24 h-22" />
